...
MemHouse is a single Mix application. It provides governed memory, retrieval,
model, document, console, portability, and release-readiness capabilities.

Use these files as the entry points for agent work:

- `AGENTS.md` — engineering rules, product invariants, and required evidence.
- `CONTRIBUTING.md` — branch, pull request, and check workflow.
