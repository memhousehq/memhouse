...
defmodule MemHouse.Repo.Migrations.RecallDocumentEmbeddingDiskannIndex do
  @moduledoc """
  Builds the 1024-dimensional recall projection DiskANN index concurrently.

  A retry removes an unrecorded valid or invalid build before recreating it;
  no table, backfill, or RLS work shares this non-transactional migration.
  """
