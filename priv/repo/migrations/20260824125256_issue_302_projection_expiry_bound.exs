defmodule MemHouse.Repo.Migrations.Issue302ProjectionExpiryBound do
  @moduledoc """
  Adds fail-closed expiry and generation validity to derived projections.
  ...
  become unreadable until a current worker rebuilds them. Rollback removes the trigger, function,
  and both validity columns.
  """

  use Ecto.Migration

  @doc """
  Adds projection validity columns and the stale-write invalidation trigger.
  ...
  @doc """
  Removes the stale-write trigger, its function, and the projection validity columns.
