...
config :memhouse, :retrieval_profiles,
  ...
  # remaining profile deadline. This prevents one lane from consuming the full thorough-profile
  # strategy budget and leaving no time for expansion or reranking.
